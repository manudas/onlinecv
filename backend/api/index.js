...
router.get('/:command/:data', function (req, res) {
    console.log('Received command:', req.params.command,
        'Data:', req.params.data, 'Query parameters:', req.query);
    let response_data_promise = engine.get(req.params.command, req.params.data, req.query);
...
router.get('/:command', function (req, res) {
    ...
    res.send(engine.get(command, req.params.data, req.query));
});
