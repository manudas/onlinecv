...
export class SkillEffects {
    ...
    translationsToRequest = ['Skill saved successfully', 'Skill removed successfully', 'Error']
            ...
            return this.dataService.setData(MutateSkills, vars).pipe(
                mergeMap(() => [
                    COMMON_ACTIONS.SUCCESS({
                        message: `${this.translate.getResolvedTranslation('Skill saved successfully', this)}`
                    }),
