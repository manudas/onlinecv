...
export const dataInputErrors         = new Map([ ['role', 'You should provide a valid tag for your skill'], ['skill_level', 'Out of range, should be between 1 and 10 or empty'] ])
