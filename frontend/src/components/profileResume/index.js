...
class ProfileResume extends Component {
    ...
    render() {
        ...
        let surname = this.props.details && this.props.details.surname ? this.props.details.surname : '';
        name = name.split(' ')[0];
...
function mapStateToProps(state) {
    ...
    const translations =
        ...
        data.translations[language]['ProfileResume']
            ...
            : null;
    return {
        profilePicture: profile_picture ? bufferToBase64(profile_picture) : null,
        resume: resume,
        details: details,
